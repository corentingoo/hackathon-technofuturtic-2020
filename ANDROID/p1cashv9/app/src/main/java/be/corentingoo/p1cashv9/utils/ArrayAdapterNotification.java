package be.corentingoo.p1cashv9.utils;
...
public abstract class ArrayAdapterNotification extends ArrayAdapter {
    public ArrayAdapterNotification(Context context, int ressources, ArrayList arrayList) {
        super(context,ressources,arrayList);
    }
