...
import be.corentingoo.p1cashv10.utils.ArrayAdapterNotification;
import be.corentingoo.p1cashv10.utils.PostCashData;
...
public class CashAdapter extends ArrayAdapterNotification {
    ...
    public View getView(int position, View view,ViewGroup parent) {
        ...
        final int percentCash = CalcPercent(CurrentCash.CurrentCapacity(),CurrentCash.MaxCapacity());
        ...
        PBCash.setProgress(percentCash);
        //Log.i("ERROR CAST?", nomMachine);
        notifyCurrentCapacity(percentCash,CurrentCash,getContext());
            ...
            public void onClick(View v) {
                if(CurrentCash.IdTypeCash()<7 || CurrentCash.IdTypeCash()>11) {
                    ...
                    if (capacity < maxCapacity) {
                        ...
                        int  percentCash = CalcPercent(capacity,maxCapacity);
                ...
                PostCashData pcd =new PostCashData();
                pcd.execute(CurrentCash);
            }
        });
