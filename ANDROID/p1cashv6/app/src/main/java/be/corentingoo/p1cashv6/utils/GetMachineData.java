...
public class GetMachineData extends AsyncTask<UrlToSend,Void, ArrayList<Machine>> {
    ...
    @Override
    protected ArrayList<Machine> doInBackground(UrlToSend... urlObject) {
        ...
        try {
            ...
            urlMachine = new URL(urlObject[0].get_url());
