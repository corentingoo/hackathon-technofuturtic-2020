package be.corentingoo.p1cashv6.utils;
...
public class GetCashData extends AsyncTask<UrlToSend,Void, ArrayList<Cash>>{

    Context AscyncContext;
    public interface CallBackCash{
        void setCallBack(ArrayList<Cash> lc, Context context);
    }
    ...
    this.callBackCash=callBackCash;
        ...
        @Override
        protected ArrayList<Cash> doInBackground(UrlToSend... urlObject) {

        AscyncContext = urlObject[0].get_Context();
        ...
        try {
             urlCash = new URL(urlObject[0].get_url());
        ...
        callBackCash.setCallBack(lc,AscyncContext);
